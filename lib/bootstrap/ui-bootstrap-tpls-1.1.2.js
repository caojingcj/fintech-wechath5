        ...
        function($modalStack, $q, $animate, $animateCss, $document) {
            return {
                ...
                link: function(scope, element, attrs) {
                    ...
                    // In customer to use this way of finding whether DOM is ready, we need to observe a scope property used in modal's template.
...
angular.module("uib/template/datepicker/popup.html", []).run(["$templateCache", function($templateCache) {
    $templateCache.put("uib/template/datepicker/popup.html",
        ...
        "    </span>\n" +
        "      <button type=\"button\" class=\"btn btn-sm btn-submission pull-right uib-close\" ng-click=\"close()\">{{ getText('close') }}</button>\n" +
        "    </li>\n" +
        "  </ul>\n" +
        "</div>\n" +
        "");
