...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            tPreview = '<div class="file-preview {class}">\n' +
                ...
                '    <div class="file-preview-status text-center text-submission"></div>\n' +
            ...
            self.defaults = {
                ...
                fileActionSettings: {
                    ...
                    indicatorSuccess: '<i class="glyphicon glyphicon-ok-sign text-submission"></i>',
        ...
        _clearPreview: function () {
            var self = this, $p = self.$preview,
                $thumbs = self.showUploadedThumbs ? self.getFrames(':not(.file-preview-submission)') : self.getFrames();
        ...
        _initSuccessThumbs: function () {
            ...
            self._getThumbs($h.FRAMES + '.file-preview-submission').each(function () {
        ...
        _uploadSingle: function (i, files, allFiles) {
            ...
            fnBefore = function (jqXHR) {
                ...
                if (self.showPreview) {
                    if (!$thumb.hasClass('file-preview-submission')) {
        ...
        _setThumbStatus: function ($thumb, status) {
            ...
            $thumb.removeClass('file-preview-submission file-preview-error file-preview-loading');
            if (status === 'Error') {
    ...
    $.fn.fileinput.defaults = {
        ...
        progressThumbClass: "progress-bar progress-bar-submission progress-bar-striped active",
        progressClass: "progress-bar progress-bar-submission progress-bar-striped active",
        progressCompleteClass: "progress-bar progress-bar-submission",
