...
!function () {
    ...
    angular.module("toaster", []).constant("toasterConfig", {
        ...
        "newest-on-top": !0,
        "time-out": 5e3,
        "icon-classes": {error: "toast-error", info: "toast-info", wait: "toast-wait", success: "toast-submission", warning: "toast-warning"},
        "body-output-type": "",
        ...
        function o(t) {
            return function (e, o, s, i, n, a, r, c, l) {
                angular.isString(e) ? this.pop(t, e, o, s, i, n, a, r, c, l) : this.pop(angular.extend(e, {type: t}))
            }
        }
        ...
        this.pop = function (e, o, s, i, n, a, r, c, l, u) {
            if (angular.isObject(e)) {
                var d = e;
                this.toast = {type: d.type, title: d.title, body: d.body, timeout: d.timeout, bodyOutputType: d.bodyOutputType, clickHandler: d.clickHandler, showCloseButton: d.showCloseButton, uid: d.toastId, onHideCallback: d.onHideCallback}, l = d.toastId, r = d.toasterId
            } else this.toast = {type: e, title: o, body: s, timeout: i, bodyOutputType: n, clickHandler: a, showCloseButton: c, uid: l, onHideCallback: u};
        ...
        }, {setup: e.setup, subscribeToNewToastEvent: e.subscribeToNewToastEvent, subscribeToClearToastsEvent: e.subscribeToClearToastsEvent, unsubscribeToNewToastEvent: e.unsubscribeToNewToastEvent, unsubscribeToClearToastsEvent: e.unsubscribeToClearToastsEvent}
    }]).directive("directiveTemplate", ["$compile", function (t) {
        return {
            restrict: "A", scope: {directiveName: "@directiveName"}, replace: !0, link: function (e, o) {
        ...
        return {
            ...
            link: function (e, r, c) {
                ...
                function u(o, i) {
                    if (o.type = v["icon-classes"][o.type], o.type || (o.type = v["icon-class"]), v["prevent-duplicates"] === !0) if (m(i)) {
                    ...
                    if ("boolean" == typeof o.showCloseButton) ; else if ("boolean" == typeof r) o.showCloseButton = r; else if ("object" == typeof r) {
                        var c = r[o.type];
                    ...
                    switch (o.bodyOutputType = o.bodyOutputType || v["body-output-type"], o.bodyOutputType) {
                        ...
                        case"templateWithData":
                            var l = t(o.body || v["body-template"]), u = l(e);
                ...
                var v, f = 0;
                v = angular.extend({}, i, e.$eval(c.toasterOptions)), e.config = {toasterId: v["toaster-id"], position: v["position-class"], title: v["title-class"], message: v["message-class"], tap: v["tap-to-dismiss"], closeButton: v["close-button"], animation: v["animation-class"], mouseoverTimer: v["mouseover-timer-stop"]}, e.$on("$destroy", function () {
                    ...
                    var o, s;
                    for (o = 0, s = e.toasters.length; s > o; o++) if (e.toasters[o].id === t) {
                        d(o);
                        break
                    }
