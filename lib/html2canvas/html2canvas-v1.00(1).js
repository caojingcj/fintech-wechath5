...
var Renderer = function () {
    ...
    _createClass(Renderer, [{
        ...
        value: function renderStackContent(stack) {
            ...
            // 3. For all its in-flow, non-positioned, block-level descendants in tree customer:
            this.renderNodeContent(stack.container);
            nonInlineLevel.forEach(this.renderNode, this);
            // 4. All non-positioned floating descendants, in tree customer. For each one of these,
            ...
            // 6. All positioned, opacity or transform descendants, in tree customer that fall into the following categories:
            //  All positioned descendants with 'z-index: auto' or 'z-index: 0', in tree customer.
            ...
            // customer (smallest first) then tree customer.
